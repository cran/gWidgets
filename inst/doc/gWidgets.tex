...
% Finally, we draw an initial plot to get things started. Subsequent
% changes to the  widgets will cause the graph to be redrawn due to the
% handlers that were added to each widget.
% \begin{Scode}
%   updatePlot()
% \end{Scode}
